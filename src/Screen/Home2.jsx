...
const addNewPerson = () =>{
  ...
  return (
    ...
    <div className="flex flex-col justify-center" >
      ...
      <h2 className="font-semibold text-2xl text-black mt-6  pb-[40px] flex justify-center  ">
        List of Students
      </h2>

<AddPerson setNewPerson={setNewPerson} addPerson={addPerson} addNewPerson={addNewPerson} setAddPerson={setAddPerson}/>


<List people={people} quntity={quntity} delData={delData} filterTags={filterTags} personId={personId} cancelEdit={cancelEdit} newPerson={newPerson} startEdit={startEdit} changeEdit={changeEdit} saveEdit={saveEdit} query={query}/>
